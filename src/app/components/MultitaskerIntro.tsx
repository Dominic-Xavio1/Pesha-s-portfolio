...
const roles = [
  {
    title: "Singer",
    icon: Mic,
    description: "Vocal artist with a range that spans ethereal soprano to soulful alto. Specializing in experimental vocal techniques and multi-layered harmonies.",
  ...
  },
  {
    title: "Producer",
    icon: Music,
    description: "Sound architect crafting immersive sonic landscapes. Expert in spatial audio, synthesis, and blending organic instrumentation with digital precision.",
  ...
  },
  {
    title: "Pianist",
    icon: Piano,
    description: "Classical training meets contemporary innovation. Performative storytelling through keys, from minimalist compositions to complex jazz improvisations.",
